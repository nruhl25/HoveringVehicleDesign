...
def f(x):
    theta_0, theta_1c, theta_1s, beta_0, lmbda, mu, alpha, phi, Lht, Ttr, Yf, Mxf, Myf, Mzr, Mzf, CY, CQ = x
    ...
    f[1] = T*sin(phi) + Y*cos(phi) + Yf + Ttr*cos(aoa_tr) - Lht*sin(alpha-psi_emp)
